use repaint::{painter::methods::{StrokingMethods, PaintStyle}, base::{paint::{Paint, Color}, defs::linalg::Vec2f64, pen::Pen, shapes::{path::PathCommand, Shape}}};

use crate::{SkiaPainter, conversions::{color_to_skia_color, paint_style_to_skia_paint}};



impl<'canvas, 'surface> StrokingMethods for SkiaPainter<'canvas, 'surface> {
    ...
    fn path(
        ...
        self.canvas.surface.canvas().draw_path(&sk_path, &paint);
    }
